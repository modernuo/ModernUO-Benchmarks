...
{
    public class NewAnimalFormGump : DynamicGump
    {
        private readonly int _ninjitsu;
        private readonly AnimalFormEntry[] _entries;

        public NewAnimalFormGump(int ninjitsu, AnimalFormEntry[] entries)
            : base(50, 50)
        {
            _ninjitsu = ninjitsu;
            _entries = entries;
        ...
        protected override void Build(ref GumpBuilder<StaticStringsHandler> builder)
        {
            ...
            int ninjitsu = _ninjitsu;// _caster.Skills[SkillName.Ninjitsu].Fixed;
            int current = 0;
        ...
        public void BuildForTest(ref GumpBuilder<StaticStringsHandler> builder)
        {
            Build(ref builder);
        }
    }
