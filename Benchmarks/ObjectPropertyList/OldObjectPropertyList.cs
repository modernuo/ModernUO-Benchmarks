...
public sealed class OldObjectPropertyList : IPropertyList
{
    ...
    public OldObjectPropertyList(IEntity e)
    {
        Entity = e;
        ...
        writer.Write(e?.Serial.Value ?? 0u);
    ...
    public void Add(ref ISelfInterpolatedStringHandler.InterpolatedStringHandler handler)
    {
        throw new NotImplementedException();
    }

    public void Add(int number, ref ISelfInterpolatedStringHandler.InterpolatedStringHandler handler)
    {
        throw new NotImplementedException();
    }
